...
static psp_paramdescr_t text2choicebsopts[] =
{
    ...
    PSP_P_FLAG  ("ign_otherop", choicebs_privrec_t, ign_otherop, 1, 0),
...
static psp_lkp_t MotifKnobs_sizes_lkp [] =
{
    {"default", -1},
    {"tiny",     8},
    {"small",   10},
...
static int CreateChoicebsKnob(DataKnob k, CxWidget parent)
{
  ...
  Dimension              mrh;
    ...
    k->u.k.behaviour |= DATAKNOB_B_STEP_FXD;
    ...
    for (y = 0;  y < me->numitems;  y++)
    {
        ...
        me->items[y] = b =
            XtVaCreateManagedWidget(k->u.k.is_rw? "push_i" : "push_o",
...
dataknob_knob_vmt_t motifknobs_choicebs_vmt =
{
    {DATAKNOB_KNOB, "choicebs",
        ...
        0,
        CreateChoicebsKnob, DestroyChoicebsKnob, NULL},
    ChoicebsSetValue_m, ChoicebsColorize_m, NULL
};
