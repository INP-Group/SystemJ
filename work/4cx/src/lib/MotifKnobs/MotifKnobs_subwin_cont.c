...
static void DoColorize(DataKnob k)
{
  ...
  CxPixel           am       = me->defam;
    ...
    MotifKnobs_ChooseColors(000, colstate, fg, bg, &fg, &bg);
...
static int CreateSubwinCont(DataKnob k, CxWidget parent)
{
  ...
  int               dlgflags;
    ...
    me->box = XhCreateStdDlg(XhWindowOf(parent), k->ident, k->u.c.str3,
                             "Close", NULL, dlgflags);
...
dataknob_cont_vmt_t motifknobs_subwin_vmt =
{
    {DATAKNOB_CONT, "subwin",
        ...
        0,
        CreateSubwinCont, DestroySubwinCont, NULL},
    NULL, NULL, NULL, NULL, NULL, NULL, SubwinNewData, NULL, NULL
};
