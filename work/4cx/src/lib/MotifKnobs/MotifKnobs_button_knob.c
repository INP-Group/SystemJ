...
{
    k->u.k.behaviour |= DATAKNOB_B_IS_LIGHT | DATAKNOB_B_IS_BUTTON | DATAKNOB_B_IGN_OTHEROP | DATAKNOB_B_STEP_FXD;
...
static int CreateButtonKnob(DataKnob k, CxWidget parent)
{
  ...
  char         *ls;
    ...
    k->w = ABSTRZE(XtVaCreateManagedWidget(k->u.k.is_rw? "push_i" : "push_o",
                                           xmPushButtonWidgetClass,
                                           CNCRTZE(parent),
                                           XmNtraversalOn, k->u.k.is_rw,
...
static int CreateArrowKnob(DataKnob k, CxWidget parent, unsigned char dir)
{
  ...
  XtResource labemuRes[] = {
    ...
    XtGetSubresources(CNCRTZE(parent), (XtPointer)&lei,
                      k->u.k.is_rw? "push_i" : "push_o", "XmPushButton",
    ...
    has_shadow = 1;
    if (!k->u.k.is_rw) has_shadow = 0;
    
    w = XtVaCreateManagedWidget(k->u.k.is_rw? "arrow_i" : "arrow_o",
...
static void ButtonSetValue_m(DataKnob k, double v)
{
  ...
  Boolean           is_enabled = (((int)v) & CX_VALUE_DISABLED_MASK) == 0;
    ...
    {
        DoButtonColorization(k, k->u.k.curstate, v);
        me->cur_lit = is_lit;
    }
...
dataknob_knob_vmt_t motifknobs_button_vmt  =
{
    {DATAKNOB_KNOB, "button",
        ...
        0,
        CreateButtonKnob, MotifKnobs_CommonDestroy_m, NULL},
    ButtonSetValue_m, ButtonColorize_m, NULL
};
...
dataknob_knob_vmt_t motifknobs_arrowlt_vmt =
{
    {DATAKNOB_KNOB, "arrowlt",
        sizeof(button_privrec_t), text2buttonopts,
        0,
        CreateArrowLT, MotifKnobs_CommonDestroy_m, NULL},
    ButtonSetValue_m, ButtonColorize_m, NULL
};
...
dataknob_knob_vmt_t motifknobs_arrowrt_vmt =
{
    {DATAKNOB_KNOB, "arrowrt",
        sizeof(button_privrec_t), text2buttonopts,
        0,
        CreateArrowRT, MotifKnobs_CommonDestroy_m, NULL},
    ButtonSetValue_m, ButtonColorize_m, NULL
};
...
dataknob_knob_vmt_t motifknobs_arrowup_vmt =
{
    {DATAKNOB_KNOB, "arrowup",
        sizeof(button_privrec_t), text2buttonopts,
        0,
        CreateArrowUP, MotifKnobs_CommonDestroy_m, NULL},
    ButtonSetValue_m, ButtonColorize_m, NULL
};
...
dataknob_knob_vmt_t motifknobs_arrowdn_vmt =
{
    {DATAKNOB_KNOB, "arrowdn",
        sizeof(button_privrec_t), text2buttonopts,
        0,
        CreateArrowDN, MotifKnobs_CommonDestroy_m, NULL},
    ButtonSetValue_m, ButtonColorize_m, NULL
};
