...
#ifndef NKSHD485_COEFF
  #define NKSHD485_COEFF 1
#endif
#ifndef NKSHD485_PRC
  #define NKSHD485_PRC "0"
#endif
...
//                    {"cfg_byte", "Cfg byte", NULL, "%3.0f", NULL, NULL, LOGT_WRITE1, LOGD_TEXT, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID(NKSHD485_BASE + NKSHD485_CHAN_CONFIG_BYTE)},
            SUBELEM_START("vel", "Velocity", 2, 2)
                {"min_vel", "[",   "/s",  "%5."NKSHD485_PRC"f", "withlabel",           NULL, LOGT_WRITE1, LOGD_TEXT, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID(NKSHD485_BASE + NKSHD485_CHAN_MIN_VELOCITY), .minnorm=32/(NKSHD485_COEFF), .maxnorm=12000/(NKSHD485_COEFF)},
                {"max_vel", "-",   "]/s", "%5."NKSHD485_PRC"f", "withlabel,withunits", NULL, LOGT_WRITE1, LOGD_TEXT, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID(NKSHD485_BASE + NKSHD485_CHAN_MAX_VELOCITY), .minnorm=32/(NKSHD485_COEFF), .maxnorm=12000/(NKSHD485_COEFF)},
            SUBELEM_END("noshadow,notitle,nocoltitles,norowtitles", NULL),
            {"accel",   "Accel", "/s^2", "%5."NKSHD485_PRC"f", "withunits", NULL, LOGT_WRITE1, LOGD_TEXT, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID(NKSHD485_BASE + NKSHD485_CHAN_ACCELERATION), .minnorm=32/(NKSHD485_COEFF), .maxnorm=65535/(NKSHD485_COEFF), .placement="horz=center"},
