...
* Created:      1989
* Modified:     Tue Apr 18 15:44:51 1995 (Niels Mayer) npm@indeed
* Language:     C
* Package:      N/A
...
/*
   NPM: for some reason, Xm/TraveActI.h now has these definitions
   but they don't seem to be part of Motif 2.0.0's "includes"
   the header is only available in the source dir motif20/lib/Xm/.
   Therefore, I kludge them here in an attempt at expedient porting
   to Motif 2.0
*/
#ifdef _NO_PROTO
