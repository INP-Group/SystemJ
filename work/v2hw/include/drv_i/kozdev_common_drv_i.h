...
enum
{
    ...
    KOZDEV_CHAN_REGS_WR8_base   = KOZDEV_CHAN_REGS_base + CANKOZ_REGS_WR8_BOFS,
    KOZDEV_CHAN_REGS_RD8_base   = KOZDEV_CHAN_REGS_base + CANKOZ_REGS_RD8_BOFS,
    KOZDEV_CHAN_REGS_WR1        = KOZDEV_CHAN_REGS_base + CANKOZ_REGS_WR1_OFS,
    KOZDEV_CHAN_REGS_RD1        = KOZDEV_CHAN_REGS_base + CANKOZ_REGS_RD1_OFS,
    KOZDEV_CHAN_REGS_last       = KOZDEV_CHAN_REGS_base + CANKOZ_REGS_NUMCHANS -1,

    KOZDEV_CHAN_REGS_RSVD_B     = KOZDEV_CHAN_REGS_base + CANKOZ_REGS_NUMCHANS,
