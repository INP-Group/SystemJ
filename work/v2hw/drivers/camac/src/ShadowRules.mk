...
CAMACHEADERSSYMLINKS=	$(CAMACDRIVERSHEADERS)
$(CAMACHEADERSSYMLINKS):	%:		$(SRCDIR)/%

$(DIRECTDRIVERSSOURCES:.c=.d):	$(CAMACHEADERSSYMLINKS)

# General symlinks' management
SHD_SYMLINKS=	$(CAMACDRIVERSSYMLINKS) $(CAMACHEADERSSYMLINKS)
