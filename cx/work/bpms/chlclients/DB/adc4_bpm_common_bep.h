...
enum
{
    ...
    DELAY_DEV_BASE = 400, // one delay line
    ATTEN_DEV_BASE = 410, // one atten line
};
...
#define DELAY_CONTROL_LINE_W(nd, nl) \
    ...
    .minnorm=0, .maxnorm=83, .incdec_step=2.5}
...
{
    {
		...
		/* ADC knobplugin */
                {"adc", NULL, NULL, NULL,
                    ...
                    " subsys=\"bep_bpm"__CX_STRINGIZE(SUBSYS_ADC004_N)"\"",
...
{
    {DELAY_CHAN_W(SUBSYS_ADC004_N, NADC4_PARAM_DELAY, CHAN_BASE               ), 1.e+3, 0, 0},
    {DELAY_CHAN_W(SUBSYS_ADC004_N, NADC4_PARAM_ATTEN, CHAN_BASE               ), 1.e+0, 0, 0},

    {DELAY_CHAN_R(SUBSYS_DELUNT_N, SUBSYS_DELCHN_N, CHAN_BASE + DELAY_DEV_BASE), 1.e+3, 0, 0},
    {DELAY_CHAN_R(SUBSYS_ATNUNT_N, SUBSYS_ATNCHN_N, CHAN_BASE + ATTEN_DEV_BASE), 1.e+0, 7, 0},
};
