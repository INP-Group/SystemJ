...
#define MAIN_LINE(l, n) \
    {"-onoff"l, "", NULL, NULL, "#-#TВыкл\f\flit=red\vВкл\f\flit=green", \
        NULL, LOGT_WRITE1, LOGD_CHOICEBS, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_ONOFF_base+n)}, \
    {"err"l, "Ошибка",     NULL, NULL, "shape=circle", NULL, LOGT_READ,   LOGD_REDLED,   LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_ERROR_base+n), .minyelw=0, .maxyelw=0.5}, \
    {"ena"l,    "",        NULL, NULL,    NULL, NULL, LOGT_WRITE1, LOGD_GREENLED, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_ENABLE_base+n), .placement="horz=center"}, \
    {"U"l"set", "U"l"уст", NULL, "%7.2f", NULL, NULL, LOGT_WRITE1, LOGD_TEXT,     LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_USET_base  +n), .minnorm=-1000, .maxnorm=+1000}, \
    {"U"l"mes", "U"l"изм", NULL, "%7.2f", NULL, NULL, LOGT_READ,   LOGD_TEXT,     LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_UMES_base  +n), .mindisp=-1000, .maxdisp=+1000}, \
    {"U"l"uvh", "U"l"увх", NULL, "%7.2f", NULL, NULL, LOGT_READ,   LOGD_TEXT,     LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_UUVH_base  +(n)*2), .mindisp=-1000, .maxdisp=+1000}, \
    {"I"l"mes", "I"l"изм", NULL, "%7.2f", NULL, NULL, LOGT_READ,   LOGD_TEXT,     LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + ( (n)<2? GID25X4_CHAN_IMES01_base+(n) : GID25X4_CHAN_IMES23_base+(n)-2))}, \
    {"D"l"beg", "З"l"зап", NULL, "%6.1f", NULL, NULL, LOGT_WRITE1, LOGD_TEXT,     LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_DBEG_base  +n), .minnorm=0, .maxnorm=6553.5},     \
    {"stp"l,    "",        NULL, NULL,    NULL, NULL, LOGT_WRITE1, LOGD_GREENLED, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_EN_STP_base+n)}, \
    {"D"l"end", "З"l"стп", NULL, "%6.1f", NULL, NULL, LOGT_WRITE1, LOGD_TEXT,     LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_DEND_base  +n), .minnorm=0, .maxnorm=6553.5}
...
#define XCEAC124_DAC_LINE(n) \
    {"dac"    __CX_STRINGIZE(n), NULL, NULL, "%7.4f", NULL, NULL, LOGT_WRITE1, LOGD_TEXT, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_XCEAC124_base + XCEAC124_CHAN_OUT_n_BASE      + n)}, \
    {"dacspd" __CX_STRINGIZE(n), NULL, NULL, "%7.4f", NULL, NULL, LOGT_WRITE1, LOGD_TEXT, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_XCEAC124_base + XCEAC124_CHAN_OUT_RATE_n_BASE + n)}, \
    {"daccur" __CX_STRINGIZE(n), NULL, NULL, "%7.4f", NULL, NULL, LOGT_READ,   LOGD_TEXT, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_XCEAC124_base + XCEAC124_CHAN_OUT_CUR_n_BASE  + n)}
#define XCEAC124_ADC_LINE(n) \
    {"adc"    __CX_STRINGIZE(n), NULL, NULL, "%9.6f", NULL, NULL, LOGT_READ,   LOGD_TEXT, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_XCEAC124_base + XCEAC124_CHAN_ADC_n_BASE+n)}
                ...
                SUBELEM_START_CRN("params", "Parameters", " ", NULL, 4, 1)
                    {"adc_time",  "",   NULL, NULL,    "1ms\v2ms\v5ms\v10ms\v20ms\v40ms\v80ms\v160ms", NULL, LOGT_WRITE1, LOGD_SELECTOR, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_XCEAC124_base + XCEAC124_CHAN_ADC_TIMECODE)},
                    {"adc_magn",  "",   NULL, NULL,    "x1\vx10\v\nx100\v\nx1000",                     NULL, LOGT_WRITE1, LOGD_SELECTOR, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_XCEAC124_base + XCEAC124_CHAN_ADC_GAIN)},
                    {"beg",       "Ch", NULL, "%2.0f", "withlabel", NULL, LOGT_WRITE1, LOGD_TEXT, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_XCEAC124_base + XCEAC124_CHAN_ADC_BEG), .minnorm=0, .maxnorm=XCEAC124_CHAN_ADC_n_COUNT-1},
                    {"end",       "-",  NULL, "%2.0f", "withlabel", NULL, LOGT_WRITE1, LOGD_TEXT, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_XCEAC124_base + XCEAC124_CHAN_ADC_END), .minnorm=0, .maxnorm=XCEAC124_CHAN_ADC_n_COUNT-1},
...
#define CGVI_LINE(n) \
    {"e"   #n, "",   NULL, "%1.0f",  NULL,                  NULL, LOGT_WRITE1, LOGD_GREENLED, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_CGVI8_base + CGVI8_CHAN_MASK1_N_BASE+n)}, \
    {"c"   #n, #n,   "q",  "%5.0f",  "withunits",           NULL, LOGT_WRITE1, LOGD_TEXT,     LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_CGVI8_base + CGVI8_CHAN_16BIT_N_BASE+n), .minnorm=0, .maxnorm=65535}, \
    {"hns" #n, "=",  "us", "%11.1f", "withlabel,withunits", NULL, LOGT_WRITE1, LOGD_TEXT,     LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_CGVI8_base + CGVI8_CHAN_QUANT_N_BASE+n), .incdec_step=0.1, .minnorm=0, .maxnorm=214700000}
                ...
                SUBELEM_START("gvi", "CGVI8", 3, 1)
                    ...
                    SUBELEM_START("ctl", "Control", 3, 2)
                        {"base",  "Base byte",   NULL, "%3.0f", "withlabel", NULL, LOGT_WRITE1, LOGD_TEXT,   LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_CGVI8_base + CGVI8_CHAN_BASEBYTE), .minnorm=0, .maxnorm=255},
                        {"scale", "q=", NULL, "%1.0f",
                            ...
                            NULL, LOGT_WRITE1, LOGD_SELECTOR, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_CGVI8_base + CGVI8_CHAN_PRESCALER)},
                        {"Start", "ProgStart",  NULL, "%3.0f", NULL, NULL, LOGT_WRITE1, LOGD_BUTTON, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_CGVI8_base + CGVI8_CHAN_PROGSTART), .placement="horz=right"},
        ...
        {"period", "Раз в", "s", "%4.1f", "withlabel,withunits", NULL,
            ...
            (excmd_t[]){
                ...
                CMD_ALLOW_W, CMD_SETP_I((CHAN_BASE) + GID25X4_CHAN_PROGSTART),
                //CMD_DEBUGP_I("zzz!"),
        ...
        {"-once", "Стук!", NULL, NULL, NULL, NULL, LOGT_WRITE1, LOGD_BUTTON, LOGK_DIRECT, LOGC_NORMAL, PHYS_ID((CHAN_BASE) + GID25X4_CHAN_PROGSTART), .placement="horz=center"},
