...
enum
{
    ...
    PPF4TD_FLAG_EOLTERM  = 1 << 1,
    PPF4TD_FLAG_HSHTERM  = 1 << 2,
    PPF4TD_FLAG_SPCTERM  = 1 << 3,
    PPF4TD_FLAG_COMTERM  = 1 << 4,
    PPF4TD_FLAG_SEMTERM  = 1 << 5,
    PPF4TD_FLAG_BRCTERM  = 1 << 6, // '}'-BRaCe, ']'-BRacKet, ')'-PaReN
};
