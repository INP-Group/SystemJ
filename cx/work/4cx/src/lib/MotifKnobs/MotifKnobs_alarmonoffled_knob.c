                               ...
                               int shape, int color)
{
  ...
  int                      n;
    ...
    k->u.k.behaviour |= DATAKNOB_B_IS_LIGHT | DATAKNOB_B_STEP_FXD;
    ...
    w = XtVaCreateManagedWidget(k->u.k.is_rw? "onoff_i" : "onoff_o",
...
{
    k->u.k.behaviour |= DATAKNOB_B_IS_ALARM;
...
{
    return CreateAlarmonoffled(k, parent, SHAPE_DEFAULT, LED_GREEN);
}
...
static void AlarmonoffledSetValue_m(DataKnob k, double v)
{
  ...
  Boolean                  is_enabled = (((int)v) & CX_VALUE_DISABLED_MASK) == 0  &&  k->u.k.is_rw;
    ...
    if (k->u.k.is_rw  &&  XtIsSensitive(CNCRTZE(k->w)) != is_enabled)
...
dataknob_knob_vmt_t motifknobs_alarm_vmt =
{
    {DATAKNOB_KNOB, "alarm",
        ...
        0,
        CreateAlarmKnob, MotifKnobs_CommonDestroy_m, NULL},
    AlarmonoffledSetValue_m, MotifKnobs_CommonColorize_m, NULL
};
...
dataknob_knob_vmt_t motifknobs_onoff_vmt =
{
    {DATAKNOB_KNOB, "onoff",
        sizeof(alarmonoffled_privrec_t), text2alarmonoffledopts,
        0,
        CreateOnoffKnob, MotifKnobs_CommonDestroy_m, NULL},
    AlarmonoffledSetValue_m, MotifKnobs_CommonColorize_m, NULL
};
...
dataknob_knob_vmt_t motifknobs_led_vmt =
{
    {DATAKNOB_KNOB, "led",
        sizeof(alarmonoffled_privrec_t), text2alarmonoffledopts,
        0,
        CreateLedKnob, MotifKnobs_CommonDestroy_m, NULL},
    AlarmonoffledSetValue_m, MotifKnobs_CommonColorize_m, NULL
};
...
dataknob_knob_vmt_t motifknobs_radiobtn_vmt =
{
    {DATAKNOB_KNOB, "radiobtn",
        sizeof(alarmonoffled_privrec_t), text2alarmonoffledopts,
        0,
        CreateRadiobtnKnob, MotifKnobs_CommonDestroy_m, NULL},
    AlarmonoffledSetValue_m, MotifKnobs_CommonColorize_m, NULL
};
