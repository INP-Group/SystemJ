...
class MainWindow (QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        self.connect(self.thread2, QtCore.SIGNAL('finished()'), self.unfreezeUi2)
        self.connect(self.thread2, QtCore.SIGNAL('terminated()'), self.unfreezeUi2)
        #self.thread.stop.connect(self.stopped) # part of proposed solution
        self.connect(self.thread2, QtCore.SIGNAL('stopped(int)'), self.stopped2) #adapted from proposed solution
